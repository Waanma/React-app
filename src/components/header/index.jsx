...
const Header = ({ onHandlerCart, user}) => {
    ...
    return (
        <div className="header-menu">
            ...
            <img src="https://cdn-icons-png.flaticon.com/512/4014/4014126.png" alt="logo" className="logo-header"></img>
            <Link to='/' className='link-logo'><h2 className="header-logo">Me Impress</h2></Link>
            ...
            <div className="header-menu-cart">
                ...
                <img className="header-menu-cart-image"  src="https://cdn-icons-png.flaticon.com/512/60/60992.png" alt="cart"/>
